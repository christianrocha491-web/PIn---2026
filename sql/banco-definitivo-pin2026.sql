...
(124, 'Pacto pela Redução do Óbito Infantil de Piracicaba', 'Rua Ipiranga, 639 – Centro', -22.72714200, -47.65102400, 'Apoio ao Pré-Natal de Alto Risco, Monitoramento Telefônico de Gestantes, Medicina Preventiva Materno-Infantil', 'Segunda a sexta-feira, das 07h30 às 17h', '3436-0511', 'Programa focado na redução e prevenção de óbitos infantis evitáveis em crianças de até 1 ano.', '2026-05-23 02:52:46', 'img/PACTO.png'),
...
SUS.', '2026-08-27 00:00:00', 'img/SANTACASA.png'),
(175, 'Hospital dos Fornecedores de Cana - HFC Saúde', 'Av. Barão de Valença, 716 ', -22.71216712, -47.65767734, 'Cardiologia, Dermatologia, Endocrinologia, Geriatria, Pediatria, Cirurgia Geral, Cirurgia de Cabeça e Pescoço, Cirurgia Plástica e Cirurgia Vascular, HFC Onco (Oncologia) e HFC Nefro (Nefrologia).', 'Atendimento 24 horas.', '(19)3403-2800', NULL, '2026-08-27 00:00:00', 'img/HFC.png');
